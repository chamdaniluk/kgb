...
<body><header class="topbar"><a class="brand" href="/">SI CENDIKIA <small>KGB ASN</small></a><nav><a href="/panduan">Tatacara</a><a href="/alur">Alur Pengajuan</a><a class="button button-small" href="/login">Masuk</a></nav></header>
<main class="container">{{.Content}}</main><footer class="footer">Dinas Pendidikan Kabupaten Grobogan · SI CENDIKIA</footer></body></html>`))
}

func (s *Server) renderPage(w http.ResponseWriter, title string, content string) {
	w.Header().Set("Content-Type", "text/html; charset=utf-8")
	if err := s.Templates.ExecuteTemplate(w, "page", pageData{Title: title, Content: template.HTML(content)}); err != nil {
