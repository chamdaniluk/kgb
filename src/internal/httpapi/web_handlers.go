...
<title>{{.Title}} · SI CENDIKIA</title><link rel="stylesheet" href="/static/style.css?v=20260818"></head>
...
func (s *Server) handleAppPage(w http.ResponseWriter, r *http.Request) {
	s.renderPage(w, r, "Aplikasi", `<section id="app" class="app-shell"><div class="loading">Memuat aplikasi…</div></section><script src="/static/app.js?v=20260818"></script>`)
}
