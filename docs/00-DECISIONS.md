...
| 2026-08-16 | **TECH STACK v1.0 FINAL**: PDF = `wkhtmltopdf`; frontend = server-rendered + vanilla JS; Go stdlib + pgx + PostgreSQL 16 | Persetujuan owner atas rekomendasi | Keenam artefak selesai; implementasi dapat dimulai |
